                              ...
                              <tr>
                                ...
                                <td>
                                	...
                                	<ul class="nav-menu">
										...
										<@perm_chow perm="admin.hm">	
										<li class="sep"></li><li class="normal" id="tb_13" onclick="HoverLi(1,3,${max});"><a href="frame/hm/main" target="mainFrame">商戶管理</a></li>
										</@perm_chow>
										<#if obj=true>
										<li class="sep"></li><li class="normal" id="tb_14" onclick="HoverLi(1,4,${max});"><a href="frame/pwd/main" target="mainFrame">修改密码</a></li>
										</#if>
                                    </ul>
                                </td>
                              </tr>
