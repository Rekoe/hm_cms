...
public class AdminKindeditor {
	...
	@Ok("json")
	@RequiresUser
	public Map<String, Object> upload(@Param("imgFile") TempFile tempFile, @Param("dir") String dir, ServletContext context, AdaptorErrorContext errCtx) throws Exception {
